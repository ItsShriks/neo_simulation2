...
def launch_setup(
    ...
    robot_description_pkg = get_package_share_directory("steve_simulation")
    ...
    use_joint_state_publisher_gui = str(
        use_joint_state_publisher_gui_arg.perform(context).lower() == "true"
    )
    ...
    rviz_config = os.path.join(
        robot_description_pkg, "rviz", "robot_description_rviz.rviz"
    )
    ...
    start_joint_state_publisher_cmd = Node(
        ...
        condition=IfCondition(
            PythonExpression(["not ", use_joint_state_publisher_gui])
        ),
    ...
    start_robot_state_publisher_cmd = Node(
        ...
        output="screen",
        parameters=[
            {"robot_description": robot_description_file, "use_sim_time": use_sim_time}
        ],
    )
...
def generate_launch_description():
    ...
    use_joint_state_publisher_gui_arg = LaunchConfiguration(
        "use_joint_state_publisher_gui"
    )
    ...
    opq_func = OpaqueFunction(function=launch_setup, args=context_arguments)
