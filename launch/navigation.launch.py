...
1. `ros2 launch steve_simulation navigation.launch.py --show-args`
   This command shows the arguments that can be passed to the launch file.
2. `ros2 launch steve_simulation navigation.launch.py map:=neo_track1 use_sim_time:=True use_multi_robots:=False use_amcl:=False`
...
def launch_setup(
    ...
    nav2_launch_file_dir = os.path.join(
        get_package_share_directory("steve_navigation"), "launch"
    )
